...
> 轻量级全栈实时在线聊天室系统 —— 架构设计文档 ——基于"https://github.com/DWHengr"linyumini二次开发构建
...
> 附录：[A. 项目结构](#附录-a-项目结构) · [B. 端口清单](#附录-b-端口清单) · [C. 开源协议](#附录-c-开源协议) · [D. 致谢与版权](#附录-d-致谢与版权)
...
meetlink:
  ...
  password: admin123                 # 管理员密码（首次登录后请立即修改）
```
